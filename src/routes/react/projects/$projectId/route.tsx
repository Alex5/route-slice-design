...
import { ProjectTabs } from "#/routes/react/projects/$projectId/-components/project-tabs/project-tabs.tsx";
import { findProject } from "#/shared/api/mock-data.ts";
import { Boundary } from "#/shared/ui/boundary/boundary.tsx";

const FILE = "src/routes/react/projects/$projectId/route.tsx";
